...
class pankajRanaActivity : AppCompatActivity() {

    private val printing = Printooth.printer(PankajPrinter())
    ...
    private fun initListeners() {
        ...
        printing.printingCallback = object : PrintingCallback {
            override fun connectingWithPrinter() {
                Toast.makeText(this@pankajRanaActivity, "Connecting with printer", Toast.LENGTH_SHORT).show()
            }

            override fun printingOrderSentSuccessfully() {
                Toast.makeText(this@pankajRanaActivity, "Order sent to printer", Toast.LENGTH_SHORT).show()
            }

            override fun connectionFailed(error: String) {
                Toast.makeText(this@pankajRanaActivity, "Failed to connect printer", Toast.LENGTH_SHORT).show()
            }

            override fun onError(error: String) {
                Toast.makeText(this@pankajRanaActivity, error, Toast.LENGTH_SHORT).show()
            }

            override fun onMessage(message: String) {
                Toast.makeText(this@pankajRanaActivity, "Message: $message", Toast.LENGTH_SHORT).show()
            }
